...
# Variables
version=6.5.9
download_url="https://cdn1.waterfox.net/waterfox/releases/${version}/Linux_x86_64/waterfox-${version}.tar.bz2"
download_filename="waterfox-${version}.tar.bz2"
download_path="/tmp/${download_filename}"
extract_dest_dir="/tmp/waterfox"
installation_dir="$HOME/.local/share/waterfox"
...
mv "$extract_dest_dir/waterfox" "$installation_dir"
...
# Creating shortcut
{
  ...
  echo "Exec=${installation_dir}/waterfox %u"
  echo "Icon=${installation_dir}/browser/chrome/icons/default/default256.png"
  echo "Terminal=false"
  ...
  echo "Exec=${installation_dir}/waterfox --new-window %u"
  echo ""
  ...
  echo "Exec=${installation_dir}/waterfox --private-window %u"
  echo ""
  ...
  echo "Exec=${installation_dir}/waterfox --ProfileManager"
