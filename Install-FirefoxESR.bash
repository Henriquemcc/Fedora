...
version="115.24.0esr"
language="en-US"
download_url="https://download-installer.cdn.mozilla.net/pub/firefox/releases/${version}/linux-x86_64/${language}/firefox-${version}.tar.bz2"
download_filename="firefox-esr-${version}.${language}.tar.xz"
download_path="/tmp/${download_filename}"
extract_dest_dir="/tmp/firefox-esr"
installation_dir="$HOME/.local/share/firefox-esr"
